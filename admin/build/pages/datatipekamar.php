...
<head>
  ...
  <title>Data Tipe Kamar Nuansa Nusantara Hotel</title>
  <!--     Fonts and icons     -->
...
<body class="m-0 font-sans text-base antialiased font-normal  leading-default bg-gray-50 text-slate-500">
  ...
  <aside class="fixed inset-y-0 flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl  max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
          <a class="bg-blue-500/13  py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors" href="datatipekamar.php">
            <div class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center fill-current stroke-0 text-center xl:p-2.5">
              <i class="relative top-0 text-sm leading-normal text-emerald-500 ni ni-credit-card"></i>
            </div>
  ...
  <main class="relative h-full max-h-screen transition-all duration-200 ease-in-out xl:ml-68 rounded-xl">
      ...
      <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
        <nav>
          ...
          <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">Data Tipe Kamar</li>
          </ol>
          <h6 class="mb-0 font-bold text-white capitalize text-2xl">Data Tipe Kamar</h6>
        </nav>
        ...
        <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
          ...
          <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
            ...
            <!-- <li class="flex items-center">
              ...
              <li class="flex items-center">
              <a href="cetak/cetaktipekamar.php" class="block px-4 py-2 text-sm font-semibold text-white transition-all ease-nav-brand">
    ...
    <div class="mb-10 mt-5 w-fit">
      <a href="function/tambahtipekamar.php" class="block ms-8 mt- py-3 px-6 rounded-lg bg-yellow-400 text-gray-800 hover:bg-slate-200 hover:scale-110 font-bold ">Tambah Data Tipe Kamar</a>
    </div>
    ...
    <?php
                if (isset($_GET['tambah'])) : ?>
                  <script>
                    Swal.fire("Data Tipe Kamar Berhasil Ditambahkan");
                  </script>
                <?php endif; ?>
                ...
                if (isset($_GET['ubah'])) : ?>
                  <script>
                    Swal.fire("Data Tipe Kamar Berhasil Diupdate");
                  </script>
                <?php endif; ?>
                ...
                if (isset($_GET['hapus'])) : ?>
                  <script>
                    Swal.fire("Data Tipe Kamar Berhasil Dihapus");
                  </script>
                <?php endif; ?>
                <!-- akhir alert -->
      ...
      <div class="flex-none w-full max-w-full px-3">
        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-xl  rounded-2xl bg-clip-border">
          <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
            <h6 class=" font-semibold text-lg">Data Tipe Kamar</h6>
          </div>
              ...
              <table class="items-center w-full mb-0 align-top border-collapse  text-slate-500">
                <thead class="align-bottom">
                  <tr>
                    ...
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none   text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-900 opacity-70">Tipe</th>
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none   text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-900 opacity-70">Nama Tipe</th>
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none   text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-900 opacity-70">Jumlah Tamu/Kamar</th>
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none   text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-900 opacity-70">Ukuran</th>
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none   text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-900 opacity-70">Harga Kamar/Permalam</th>
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none   text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-900 opacity-70">Deskripsi</th>
                    <th class="px-6 py-3 font-bold text-center uppercase align-middle bg-transparent border-b border-collapse shadow-none   text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-900 opacity-70">Image</th>
                ...
                <?php 
                  ...
                  $num = 1;
                  while ($tipekamar = $hasil->fetch_assoc()) {
                  ?>

                    <tr>
                      <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center w-[5%]"><?= $num ?>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center"><?= $tipekamar['slug'] ?>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center"><?= $tipekamar['nama_tipe'] ?>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center"><?= $tipekamar['jmlh_tamu'] ?>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center"><?= $tipekamar['ukuran'] ?>sqm
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center">Rp.<?= $tipekamar['harga'] ?>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center"><?= $tipekamar['deskripsi'] ?>
                      </td>
                      <td ><img class="w-full rounded-md" style="max-width: 700px;" src="../assets/img/<?= $tipekamar['image'] ?>.jpeg" alt="" />
                      </td>
                      <td class="  inline-block p-2 align-middle bg-transparent border-b  whitespace-nowrap shadow-transparent text-center">
                        <a href="function/edittipekamar.php?id=<?= $tipekamar['tipe_kamar_id'] ?>"><i class="material-icons text-center">edit</i></a>
                        <a href="function/hapustipekamar.php?id=<?= $tipekamar['tipe_kamar_id'] ?>" onclick=" return confirm ('Apakah Anda Yakin Ingin Menghapus data Ini ?');"><i class="material-icons text-center">delete</i></a>
                      </td>
                    </tr>
                    <?php $num++;
                  }
