...
<div id="gallery" class="relative w-full" data-carousel="slide">
    ...
    <div class="relative h-screen overflow-hidden rounded-lg md:h-screen">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="../assets/images/dtb1.jpeg" class="w-screen absolute inset-0 object-cover object-center" alt="">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
            <img src="../assets/images/ddb1.jpeg" class="w-screen absolute inset-0 object-cover object-center" alt="">
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
        ...
        <!-- Item 4 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="../assets/images/dtb3.jpeg" class="w-screen absolute inset-0 object-cover object-center" alt="">
        </div>
    </div>
    <!-- Slider controls -->
    ...
    <!-- detai kamar -->
    <section>
    <h3 class="text-slate-800 text-3xl font-semibold pt-10 pb-5 ms-5 text-center lg:text-5xl lg:font-semibold" data-aos="fade-right" style="font-family: 'Great Vibes';">Deluxe</h3>
    <p class="text-justify text-lg lg:text-base mx-28 px-11 mb-11" data-aos="fade-left">Kamar Deluxe Nuansa Nusantara Hotel memungkinkan Anda menikmati kamar berdesain khas seluas 30 meter persegi yang diperkaya dengan warna emas-perunggu dengan suasana klasik yang sesungguhnya dan juga dilengkapi dengan rangkaian fasilitas dan fasilitas yang lengkap. Kamar Deluxe yang nyaman di Hotel Nuansa Nusantara memiliki semua yang Anda butuhkan untuk pengalaman menginap yang tak terlupakan.</p>
    </section>
    <!-- akhir detail kamar -->
