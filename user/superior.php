...
<div id="gallery" class="relative w-full" data-carousel="slide">
    ...
    <div class="relative h-screen overflow-hidden rounded-lg md:h-screen">
        ...
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="../assets/images/stb1.jpeg" class=" w-screen absolute inset-0 object-cover object-center" alt="">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
            <img src="../assets/images/sdb1.jpeg" class="w-screen absolute inset-0 object-cover object-center" alt="">
        </div>
        <!-- Item 3 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
    ...
    <!-- detai kamar -->
    <section>
    <h3 class="text-slate-800 text-3xl font-semibold pt-10 pb-5 ms-5 text-center lg:text-5xl lg:font-semibold" data-aos="fade-right" style="font-family: 'Great Vibes';">Superior</h3>
    <p class="text-justify text-lg lg:text-base mx-28 px-11 mb-11" data-aos="fade-left">Kamar Superior seluas 27 meter persegi dengan tempat tidur double atau twin dilengkapi dengan seni klasik-modern yang menawarkan kenyamanan, dilengkapi dengan shower berdiri air panas & dingin, TV LED 42″, akses Wi-Fi berkecepatan tinggi gratis, lemari pakaian, di - Fasilitas pembuat kopi & teh di kamar, air mineral gratis, sandal, kursi sofa yang nyaman, dan balkon menyempurnakan lingkungan sekitar. Kamar terhubung tersedia berdasarkan permintaan. Untuk kenyamanan yang terjangkau, menginap di Hotel Nuansa Nusantara bernilai tinggi. Kamar superior adalah pilihan bagus yang dapat dinikmati siapa saja.</p>
    </section>
    <!-- akhir detail kamar -->
...
<ul class="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
    ...
    <!-- akhir fasilitas kamar -->
        ...
        <!-- home -->
        <section class="home bg-yellow-400 w-fit p-3 rounded-2xl fixed bottom-5 right-5 opacity-30 hover:opacity-100 z-[999]">
      <a href="../index.php">
